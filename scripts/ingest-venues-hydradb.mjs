...
const venues = [
  ...
  { name: "Costco Hot Dog", slug: "costco-hotdog", category: "food", subcategory: "hot dogs", neighborhood: "SoMa", address: "450 10th St", price_tier: 1, avg_price: "$1.50", tags: ["bulk", "value", "local_icon"], is_chain: true, description: "$1.50 hot dog + 20oz soda combo, unchanged since 1985", lat: 37.7700, lng: -122.4050 },
